  ...
  const features: Feature[] = [
    {
      ...
      description:
        'Conecte-se com outros criadores independentes, compartilhe ideias e receba feedback valioso',
      icon: Users,
    ...
    },
    {
      ...
      description:
        'Acesse guias, ferramentas e recursos exclusivos para acelerar o crescimento do seu SaaS',
      icon: Lightbulb,
    ...
    },
    {
      title: 'Mentoria',
      description:
        'Aprenda com empreendedores experientes que já construíram SaaS lucrativos do zero',
      icon: GraduationCap,
    ...
    },
    {
      ...
      description:
        'Encontre parceiros para colaborações, desde co-fundadores até fornecedores de serviços',
      icon: Handshake,
    ...
    },
    {
      ...
      description:
        'Participe de eventos online e presenciais para expandir seu conhecimento e networking',
      icon: Calendar,
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} rounded-2xl translate-y-4 blur-xl opacity-0 group-hover:opacity-70 transition-all duration-300`}
                ></div>

                <div
                  className={`h-full overflow-hidden rounded-2xl backdrop-blur-sm border-2 ${feature.borderColor} bg-white/50 shadow-lg transition-all hover:shadow-xl dark:bg-slate-900/50`}
                >
                  <div className={`relative h-full p-8`}>
                    <div className="relative space-y-5">
                      <div
                        className={`flex h-16 w-16 items-center justify-center rounded-xl ${feature.iconBg} shadow-lg ${feature.color} transition-transform group-hover:scale-110 group-hover:rotate-3`}
                      >
