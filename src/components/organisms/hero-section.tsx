    ...
    <section className="relative overflow-hidden pt-20 pb-10 md:pt-32 md:pb-16">
      ...
      <div className="relative px-4 md:px-6">
        <div className="mx-auto max-w-5xl pb-16 text-center md:pb-24">
          ...
          >
            A comunidade definitiva para desenvolvedores, vendedores e designers criarem SaaS lucrativos no Brasil
          </motion.p>
          ...
          >
            ...
            >
              <Button size="lg" className="h-14 px-8 text-lg font-medium group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-md hover:shadow-xl transition-all relative overflow-hidden">
            ...
            >
              <div className={`absolute inset-0 rounded-2xl ${
                index % 2 === 0 
                  ? "bg-blue-300/5" 
                  : "bg-indigo-300/5"
              } translate-y-2 blur-lg opacity-0 group-hover:opacity-100 transition-all duration-300`}></div>
              
              <StatCard
                stat={stat}
                highlightValue={true}
                className={`border-2 backdrop-blur-md shadow-lg hover:shadow-xl transition-all ${
                  index % 2 === 0 
